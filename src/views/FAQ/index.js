    ...
    <section className='content'>
      <div className='row'>
        <div className='col-md-12'>
          ...
          <p>
            I did realy like, and a very fan of NoFlow or Workflow for iOS, IFTTT, Automator, Zapier, Huggin, google
            Blocky.
            ...
            So i did make a choice to make it human readable and have your flow ordered by a single list, as human we
            like list it's common, anchor into our usage, affordable and natural to read from top to bottom.
            At the end you can make anything into each blocks, so have conditions, loops and so on as long as something
          ...
          <p>
            The goal is to deserve realy anything. So a block can be a simple text transformation as it can be a very
            specific process.
