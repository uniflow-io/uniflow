...
import routes, { pathTo } from '@uniflow-io/uniflow-client/src/routes';
import { UserManager } from '@uniflow-io/uniflow-client/src/components';
import { getNewLogs, commitReadLog } from '@uniflow-io/uniflow-client/src/contexts/logs';
import { commitLogoutUser } from '@uniflow-io/uniflow-client/src/contexts/user';
import { isGranted } from '@uniflow-io/uniflow-client/src/contexts/user';
import { useApp, useAuth, useLogs, useUser } from '@uniflow-io/uniflow-client/src/contexts';
import Container from '@uniflow-io/uniflow-client/src/container';
import { Path } from '@uniflow-io/uniflow-client/src/services';
import { Env } from '@uniflow-io/uniflow-client/src/services';
import { useEffect } from 'react';
import { IGatsbyImageData } from 'gatsby-plugin-image';
import { ROLE } from '@uniflow-io/uniflow-client/src/models/api-type-interfaces';
import { Log } from '@uniflow-io/uniflow-client/src/models';
import Alert, { AlertType } from '@uniflow-io/uniflow-client/src/components/alert';
...
const Layout: FC<LayoutProps> = (props) => {
  ...
  return (
    // Loading (Static Query) issue : https://github.com/gatsbyjs/gatsby/issues/6350
    <StaticQuery
      query={graphql`
        query LayoutQuery {
          site {
