      ...
      <section className="section container-fluid">
        <figure className="figure-fluid">
          {article.frontmatter.cover.childImageSharp && (
            <Img className="figure-img img-fluid" fluid={article.frontmatter.cover.childImageSharp.fluid} alt="Cover" />
          )}
          {article.frontmatter.cover.extension === "svg" && (
            <img className="figure-img img-fluid" src={article.frontmatter.cover.publicURL} alt="Cover" />
          )}
