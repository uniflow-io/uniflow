const SRL = (function() {
  function r(e, n, t) {
    function o(i, f) {
      if (!n[i]) {
        if (!e[i]) {
          let c = typeof require === 'function' && require
          if (!f && c) return c(i, !0)
          if (u) return u(i, !0)
...
})()(
  {
    1: [
      function(require, module, exports) {
        ...
        const METHOD_TYPES_ALLOWED_FOR_CHARACTERS =
          METHOD_TYPE_BEGIN |
          METHOD_TYPE_ANCHOR |
          METHOD_TYPE_GROUP |
          METHOD_TYPE_QUANTIFIER |
          METHOD_TYPE_CHARACTER
        ...
        class Builder {
          ...
          raw(regularExpression) {
            regularExpression =
              regularExpression instanceof RegExp
            ...
            if (!this._isValid()) {
              ...
              throw new BuilderException(
                'Adding raw would invalidate this regular expression. Reverted.'
              )
            }
           ...
           */
          oneOf(chars) {
            this._validateAndAddMethodType(
              METHOD_TYPE_CHARACTER,
              METHOD_TYPES_ALLOWED_FOR_CHARACTERS
            )

            let result = chars
              .split('')
              .map(character => this.escape(character))
              .join('')
          ...
          anyOf(conditions) {
            ...
            return this._addClosure(
              new Builder()._extends('(?:%s)', '|'),
              conditions
            )
          }
          ...
          optional(conditions = null) {
            this._validateAndAddMethodType(
              METHOD_TYPE_QUANTIFIER,
              METHOD_TYPE_CHARACTER | METHOD_TYPE_GROUP
            )
          ...
          lazy() {
            ...
            if (!chars.includes(last)) {
              if (last === ')' && chars.includes(raw.substr(-2, 1))) {
                const target =
                  lastMethodType === METHOD_TYPE_GROUP
                    ? this._revertLast().slice(0, -1) + '?)'
                    : '?'
                return this.add(target)
              }

              throw new ImplementationException(
                'Cannot apply laziness at this point. Only applicable after quantifier.'
              )
            }
          ...
          escape(character) {
            return (
              (NON_LITERAL_CHARACTERS.includes(character) ? '\\' : '') +
              character
            )
          }
           ...
           */
          getRawRegex() {
            return this._group.replace(
              '%s',
              this._regEx.join(this._implodeString)
            )
          }
          ...
          get() {
            if (this._isValid()) {
              ...
              throw new SyntaxException(
                'Generated expression seems to be invalid.'
              )
            }
          }
      ...
      {
        './Exceptions/Builder': 3,
        './Exceptions/Implementation': 4,
        './Exceptions/Syntax': 6,
      },
    ],
    2: [
      ...
      function(require, module, exports) {
        ...
        class Literally {
          ...
          constructor(string) {
            ...
            this._string = string.replace(/\\(.)/gm, '$1')
          }
          ...
          for (let i = 0; i < query.length; i++) {
            ...
            try {
              ...
              if (Array.isArray(parameters[lastIndex])) {
                ...
                throw new SyntaxException(
                  `Invalid parameter given for ${method.origin}`
                )
              }
            }
          }
    ...
    10: [
      ...
      {
        '../../Exceptions/Syntax': 6,
        '../Methods/AndMethod': 13,
        '../Methods/AsMethod': 14,
        '../Methods/Method': 15,
        '../Methods/SimpleMethod': 16,
        '../Methods/TimesMethod': 17,
        '../Methods/ToMethod': 18,
        './buildQuery': 9,
      },
    ],
    11: [
      function(require, module, exports) {
        ...
        function parseParentheses(query) {
          ...
          loop: for (let i = 0; i < stringLength; i++) {
            const char = query[i]
          ...
          if (openPos !== closePos) {
            ...
            result = result.concat(
              [
                ...
                parseParentheses(
                  query.substr(openPos + 1, closePos - openPos - 1)
                ),
        ...
        function createLiterallyObjects(query, openPos, stringPositions) {
          ...
          stringPositions.forEach(stringPosition => {
            ...
            if (stringPosition.end < firstRaw.length) {
              ...
              result.push(
                firstRaw.substr(pointer, stringPosition.start - pointer).trim()
              )
    ...
    12: [
      function(require, module, exports) {
        ...
        class Interpreter {
           ...
           */
          build() {
            this.resolvedQuery = this.resolveQuery(
              parseParentheses(this.rawQuery)
            )
            ...
            for (let i = 0; i < query.length; i++) {
              ...
              if (typeof item === 'string') {
                ...
                try {
                  ...
                  const leftOver = item.replace(
                    new RegExp(method.origin, 'i'),
                    ''
                  )
                  query[i] = method
                  if (leftOver !== '') {
                ...
                throw new InterpreterException(
                  `Unexpected statement: ${JSON.stringify(item)}`
                )
              }
            }
      ...
      {
        '../Exceptions/Interpreter': 5,
        './Helpers/Cache': 7,
        './Helpers/Literally': 8,
        './Helpers/buildQuery': 9,
        './Helpers/methodMatch': 10,
        './Helpers/parseParentheses': 11,
      },
    ],
    13: [
      function(require, module, exports) {
          ...
          callMethodOn(builder) {
            ...
            try {
              ...
              if (e instanceof ImplementationException) {
                ...
                throw new SyntaxException(
                  `'${methodName}' does not allow the use of sub-queries.`
                )
              }
            }
          }
    ...
    19: [
      ...
      { './Builder': 1, './Language/Interpreter': 12 },
    ],
  },
  {},
  [19]
