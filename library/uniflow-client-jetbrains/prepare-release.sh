...
echo "</ul>" >> change-notes.html
echo "<p>more changes can be found at https://github.com/darkwood-fr/uniflow/tree/master/library/uniflow-client-jetbrains/CHANGELOG.md</p>" >> change-notes.html
echo "</html>" >> change-notes.html
