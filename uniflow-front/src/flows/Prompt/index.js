        ...
        <form className='form-horizontal'>
          ...
          <div className='box-body'>
            ...
            <div className='form-group'>
              ...
              <div className='col-sm-10'>
                <input id='variable{{ _uid }}' type='text' value={messageVariable || ''}
                       onChange={this.onChangeMessageVariable} className='form-control'/>
              </div>
            </div>
            ...
            {promptDisplay && type === 'string' && (
              <div className='form-group'>
                ...
                <div className='col-sm-10'>
                  <input id='input_string{{ _uid }}' type='text' value={input || ''} onChange={this.onChangeInputString}
                         className='form-control'/>
                </div>
              </div>
            )}
            ...
            {promptDisplay && type === 'text' && (
              <div className='form-group'>
                ...
                <div className='col-sm-10'>
                  <AceComponent className='form-control' id='input_text{{ _uid }}' value={input || ''}
                                onChange={this.onChangeInputText} placeholder='Text' height='200'/>
                </div>
              </div>
            )}
            ...
            {promptDisplay && type === 'file' && (
              <div className='form-group'>
                ...
                <div className='col-sm-10'>
                  <input id='input_file{{ _uid }}' type='file' onChange={this.onChangeInputFile}
                         className='form-control'/>
                </div>
              </div>
            )}
